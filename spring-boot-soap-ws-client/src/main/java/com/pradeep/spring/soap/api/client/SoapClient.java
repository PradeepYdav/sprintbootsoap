package com.pradeep.spring.soap.api.client;
...
public class SoapClient {
	...
	public Acknowledgement getLoanStatus(CustomerRequest request) {
		...
		Acknowledgement acknowledgement= (Acknowledgement) template.marshalSendAndReceive("http://localhost:8083/ws/",request);
